...
shapefile_file="Y:/PICCC_analysis/DLNR_plantVA/shapefiles/RFF_Funded_Fence.shp"
shapefile_col="GlobalID"
...
raster_files=["330_NC_Nex_HiVuln_zone2_partial_ensemble.tif"]
#raster_names=["Micro_refugia", "Tolerate", "Migrate", "Current", "Future", "Winkout", "No_overlap"]
raster_names=["NC_Nex_HiVuln_zone2"]
