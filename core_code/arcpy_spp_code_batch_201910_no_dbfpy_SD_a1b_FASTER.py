...
island="all" #
rootdir=r"E:/VA2_rerun/output/A1B/" #location for outputs. ?whichever is data dir, will have to have subfolders: results/, results/la/, la/ (where you place CCE and FCE files)
...
ce_data_dir=r"E:/VA2_rerun/data/CEs V2_2019/a1b/" #location of climate envelope files "Y:/PICCC_data/VA data/CEs_500m/"
