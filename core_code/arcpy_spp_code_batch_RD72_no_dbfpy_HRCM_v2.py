...
#python D:\Dropbox\code\arcpyVAtool\core_code\arcpy_spp_code_batch_RD72_no_dbfpy_HRCM_v2.py
#if running parallel, must run this from cmd with script above, python must be on system path

#USER INPUT
island="all" #
rootdir=r"Y:/PICCC_analysis/plant_landscape_va_results/allSpp_allIsl_DDA1B/" #location for outputs. ?whichever is data dir, will have to have subfolders: results/, results/la/, la/ (where you place CCE and FCE files)
...
ce_data_dir=r"Y:/PICCC_data/VA data/DD A1B HRCM v2 CEs/range maps archipelago reprojected 2bits/" #location of climate envelope files "Y:/PICCC_data/VA data/CEs_500m/"
