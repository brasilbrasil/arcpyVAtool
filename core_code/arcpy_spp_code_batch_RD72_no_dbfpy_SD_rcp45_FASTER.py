...
#USER INPUT
island="all" #
rootdir=r"Y:/PICCC_analysis/plant_landscape_va_results/allSpp_allIsl_SD_rcp45 V2/" #location for outputs. ?whichever is data dir, will have to have subfolders: results/, results/la/, la/ (where you place CCE and FCE files)
...
ce_data_dir=r"Y:/PICCC_data/VA data/SD RCP45 CEs V2/range maps archipelago reprojected 2bits/" #location of climate envelope files "Y:/PICCC_data/VA data/CEs_500m/"
