...
ugly=arcpy.Raster(landscape_factor_dir+"habqual_v3_4_ugly.tif")
lava=arcpy.Raster(landscape_factor_dir+"habqual_v3_4_bare.tif")
habqual_v3_4=arcpy.Raster("habqual_v3_4.tif")
island=arcpy.sa.SetNull(habqual_v3_4,1,"Value < 1")
slr=arcpy.Raster(landscape_factor_dir+"all_island_1m_slr.tif")
...
area_subtr_pioneer2=area_subtr_pioneer2*island
loc_save="area_subtr_pioneer_v2.tif"
...
area_subtr2=area_subtr2*island
loc_save="area_subtr_v2.tif"
