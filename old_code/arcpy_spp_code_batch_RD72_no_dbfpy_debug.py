...
#python D:\Dropbox\code\arcpyVAtool\core_code\arcpy_spp_code_batch_RD72_no_dbfpy_debug.py
...
calculate_veg_type_areas=True #this is not working on parallel
...
if calc_cce_total_area:
    def calc_cce_total_area_fx2(sp_code_st, resultsdir, sp_code): #no other var calls
        ...
        return metric_previously_done, metric_NA2
