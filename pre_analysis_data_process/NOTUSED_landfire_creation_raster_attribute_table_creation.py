#python D:\Dropbox\code\arcpyVAtool\pre_analysis_data_process\landfire_creation_raster_attribute_table_creation.py
#must run this from cmd with script above, python must be on system path

#USER INPUT
rootdir=r"Y:/PICCC_data/VA data/Phase2/veg_data/"
overwrite=False
